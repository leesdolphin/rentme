# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-06-10 03:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('address', models.TextField(help_text='The address of the company HQ.', null=True)),
                ('billing_type', models.IntegerField(help_text='The billing type for the company.', null=True)),
                ('city', models.TextField(help_text='The city where the company HQ is located.', null=True)),
                ('e_mail', models.TextField(help_text='A contact email address for the company.', null=True)),
                ('fax_number', models.TextField(help_text='A fax number for the company.', null=True)),
                ('id', models.IntegerField(help_text='The ID of the company.', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('e_mail', models.TextField(help_text='Gets the email of the dealer', null=True)),
                ('fax_number', models.TextField(help_text='Get the fax number of a contact', null=True)),
                ('first_name', models.TextField(help_text='The agent’s first name.', null=True)),
                ('full_name', models.TextField(help_text='Get the name of a contact', null=True)),
                ('home_phone_number', models.TextField(help_text='Get the home phone number of a contact', null=True)),
                ('mobile_phone_number', models.TextField(help_text='Get the mobile phone number of a contact', null=True)),
                ('office_phone_number', models.TextField(help_text='Get the office phone number of a contact', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_name', models.TextField(help_text='The name of the attribute, in a form suitable for displaying to users. Not required when selling or editing.', null=True)),
                ('display_value', models.TextField(help_text='The value of the attribute as it needs to be displayed to the end users', null=True)),
                ('group_name', models.TextField(help_text='Suggests the category name for the attribute grouping on the UI level.', null=True)),
                ('is_required_for_sell', models.NullBooleanField(help_text='Indicates whether the attribute must be present when selling an item.')),
                ('max_string_length', models.IntegerField(help_text='The maximum allowed length of the attribute value, in characters. Only applies to string attributes. Some string attributes do not have a maximum length because they are restricted to a fixed list of options, or because any length is acceptable. Not required when selling or editing.', null=True)),
                ('name', models.TextField(help_text='A name which uniquely identifies the attribute. Required when selling or editing.', null=True)),
                ('type', models.IntegerField(choices=[(0, 'None'), (1, 'Boolean'), (2, 'Integer'), (3, 'Decimal'), (4, 'String'), (5, 'DateTime')], help_text='The type of the attribute, which determines the range of acceptable values. Not required when selling or editing.', null=True)),
                ('unit', models.TextField(help_text='The selected unit. Only applicable to attributes that have at least one associated unit. This field is optional, but if supplied, will be saved along with the value. The list of valid units can be retrieved from the category details API .', null=True)),
                ('value', models.TextField(help_text='The string value of the attribute. When listing, the valid values for the attribute can be determined using the “Retrieve attributes for a category” API. Use “false” or “true” for boolean attributes. Required when selling or editing.', null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('display', models.TextField(help_text='The unit name, in a format suitable for displaying to a user (e.g. “MHz”).', null=True)),
                ('multiplier', models.FloatField(help_text='The multiplier to apply to the value the user entered to get a value suitable for passing to the sell API.', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Bid',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('agent_id', models.TextField(help_text='The REAA number of the agent, used to connect this listing to an agent', null=True)),
                ('alternate_phone_number', models.TextField(help_text='The secondary phone number of the contact. Can be either a mobile or landline number. Optional.', null=True)),
                ('branding_image_id', models.IntegerField(help_text='The ID of the branding image to display an agent photo on this listing. See the upload branding image API . Optional.', null=True)),
                ('e_mail', models.TextField(help_text='The email address of the contact to be used for email enquiries. Optional.', null=True)),
                ('full_name', models.TextField(help_text='The full name of the contact person or agent. Mandatory.', null=True)),
                ('phone_number', models.TextField(help_text='The primary phone number of the contact. Can be either a mobile or landline number. Optional.', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ContactDetails',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.TextField(help_text='The description of the error, if the operation failed.', null=True)),
                ('draft_id', models.IntegerField(help_text='The ID of the draft.', null=True)),
                ('status_code', models.IntegerField(choices=[(0, 'Success'), (1, 'MaxLimitExceeded')], help_text='The draft listing request status.', null=True)),
                ('success', models.NullBooleanField(help_text='Indicates whether the operation was successful.')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_in_trade', models.NullBooleanField(help_text='Indicates whether the member is a professional trader.')),
                ('is_top_seller', models.NullBooleanField(help_text='Indicates whether the member is currently a Top Seller')),
                ('member_id', models.IntegerField(help_text='The ID of the member. This may be 0 , if we determine it is necessary to protect the member’s privacy.', null=True)),
                ('nickname', models.TextField(help_text='The nickname of the member. Some characters may be changed, if we determine it is necessary to protect the member’s privacy.', null=True)),
                ('suburb', models.TextField(help_text='The name of the member’s suburb.', null=True)),
                ('unique_negative', models.IntegerField(help_text='The number of distinct members who have placed negative feedback against this member.', null=True)),
                ('unique_positive', models.IntegerField(help_text='The number of distinct members who have placed positive feedback against this member.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(blank=True, help_text='Basic information about the member.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='member_profile_reverse_member', to='raw.Member0')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='Promotion',
            fields=[
                ('description', models.TextField(help_text='A short description of the promotion.', null=True)),
                ('discount_description', models.TextField(help_text='A short description of any discount applied to this promotion.', null=True)),
                ('discount_disclaimer', models.TextField(help_text='The legal disclaimer of any discount applied to this promotion.', null=True)),
                ('discount_end_date', models.TextField(help_text='The end date of any discount applied to this promotion.', null=True)),
                ('discount_start_date', models.TextField(help_text='The start date of any discount applied to this promotion.', null=True)),
                ('id', models.IntegerField(help_text='The unique identifier of the promotion.', primary_key=True, serialize=False)),
                ('long_description', models.TextField(help_text='A long description of the promotion.', null=True)),
                ('minimum_photo_count', models.IntegerField(help_text='The minimum number of photos required for the promotion.', null=True)),
                ('name', models.TextField(help_text='The name of the promotion.', null=True)),
                ('original_price', models.FloatField(help_text='The price of the promotion before any discounts have been applied.', null=True)),
                ('price', models.FloatField(help_text='The current price of the promotion. This price should include any discounts currently applied.', null=True)),
                ('recommended', models.NullBooleanField(help_text='Whether this promotion is currently being recommended.')),
            ],
        ),
        migrations.CreateModel(
            name='Properties',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('depth', models.FloatField(help_text='Depth value for box package type', null=True)),
                ('filter_option', models.IntegerField(choices=[(0, 'BestPrice'), (1, 'CourierPost'), (2, 'Fastway')], help_text='Courier filter for calculation', null=True)),
                ('height', models.FloatField(help_text='Height value for box package type', null=True)),
                ('is_box_type', models.NullBooleanField(help_text='Indicator if package type is bag or box')),
                ('is_rural', models.NullBooleanField(help_text='Indicator on if pickup location is rural area')),
                ('is_signature_required', models.NullBooleanField(help_text='Inidicator if shipping requires signature')),
                ('packaging_option', models.IntegerField(choices=[(1, 'Box'), (2, 'DLE'), (3, 'A4'), (4, 'A3'), (5, 'A5')], help_text='Packaging type indicating bag sizes or box', null=True)),
                ('pickup_locality_id', models.IntegerField(help_text='Pickup location id', null=True)),
                ('weight_option', models.IntegerField(choices=[(1, 'Kg0To3'), (2, 'Kg3To5'), (3, 'Kg5To10'), (4, 'Kg10To15'), (5, 'Kg15To20'), (6, 'Kg20To25')], help_text='Weight range option for calculation', null=True)),
                ('width', models.FloatField(help_text='Width value for box package type', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Variant',
        ...
        migrations.AlterUniqueTogether(
            name='tmshippingcalculatorinputs',
            unique_together=set([('depth', 'filter_option', 'height', 'is_box_type', 'is_rural', 'is_signature_required', 'packaging_option', 'pickup_locality_id', 'weight_option', 'width')]),
        ),
        migrations.AlterUniqueTogether(
            name='storepromotion',
        ...
        migrations.AddField(
            model_name='property',
            name='agency',
            field=models.ForeignKey(blank=True, help_text='Details of the agency this property was listed by.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='property_reverse_agency', to='raw.Agency0'),
        ),
        migrations.AddField(
            model_name='property',
            name='branding',
        ...
        migrations.AlterUniqueTogether(
            name='member0',
            unique_together=set([('date_address_verified', 'date_joined', 'feedback_count', 'import_charges_may_apply', 'is_address_verified', 'is_authenticated', 'is_dealer', 'is_in_trade', 'is_top_seller', 'member_id', 'nickname', 'suburb', 'unique_negative', 'unique_positive')]),
        ),
        migrations.AlterUniqueTogether(
            name='member',
        ...
        migrations.AddField(
            model_name='flatmate',
            name='agency',
            field=models.ForeignKey(blank=True, help_text='Details of the agency this property was listed by.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='flatmate_reverse_agency', to='raw.Agency0'),
        ),
        migrations.AddField(
            model_name='flatmate',
            name='branding',
        ...
        migrations.AlterUniqueTogether(
            name='draftlistingresponse',
            unique_together=set([('description', 'draft_id', 'status_code', 'success')]),
        ),
        migrations.AlterUniqueTogether(
            name='dealershowroom',
            unique_together=set([('id',)]),
        ...
        migrations.AlterUniqueTogether(
            name='contact',
            unique_together=set([('agent_id', 'alternate_phone_number', 'branding_image_id', 'e_mail', 'full_name', 'phone_number')]),
        ),
        migrations.AlterUniqueTogether(
            name='charity',
        ...
        migrations.AlterUniqueTogether(
            name='attributeunit',
            unique_together=set([('display', 'multiplier')]),
        ),
        migrations.AlterUniqueTogether(
            name='attributerange',
        ...
        migrations.AddField(
            ...
            name='options',
            field=models.ManyToManyField(help_text='A list of options, if the attribute is restricted to a fixed set of values. Not required when selling or editing.', related_name='attribute0_reverse_options', to='raw.AttributeOption0'),
        ),
        migrations.AddField(
            model_name='attribute0',
            name='range',
            field=models.ForeignKey(blank=True, help_text='The allowed range of the attribute. Only applies to numeric attributes. Not required when selling or editing.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='attribute0_reverse_range', to='raw.AttributeRange'),
        ),
        migrations.AddField(
            model_name='attribute0',
            name='units',
            field=models.ManyToManyField(help_text='A list of units that apply (MHz, hectares, etc). Only applies to numeric attributes. Not required when selling or editing.', related_name='attribute0_reverse_units', to='raw.AttributeUnit'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='agency0',
            name='agents',
            field=models.ManyToManyField(help_text='The contact details of contacts within the agency.', related_name='agency0_reverse_agents', to='raw.Agent0'),
        ),
        migrations.AddField(
            model_name='agency0',
            name='branding',
            field=models.ForeignKey(blank=True, help_text='The branding object for the company.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='agency0_reverse_branding', to='raw.Branding'),
        ),
        migrations.AddField(
            model_name='agency',
            name='agents',
        ...
        migrations.AddField(
            ...
            name='bullet_points',
            field=models.ManyToManyField(help_text='The bullet points for display in the search results', related_name='additional_data_reverse_bullet_points', to='raw.AdditionalDataBulletPoints'),
        ),
        migrations.AlterUniqueTogether(
            name='variant',
        ...
        migrations.AlterUniqueTogether(
            name='attribute0',
            unique_together=set([('display_name', 'display_value', 'group_name', 'is_required_for_sell', 'max_string_length', 'name', 'range', 'type', 'unit', 'value')]),
        ),
        migrations.AlterUniqueTogether(
            name='attribute',
